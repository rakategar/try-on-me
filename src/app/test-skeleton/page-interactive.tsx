...
const POSE_PRESETS: PosePreset[] = [
  {
    ...
    landmarks: [
      ...
      { name: "left_eye", x: 0.48, y: 0.1 },
      { name: "right_eye", x: 0.52, y: 0.1 },
  ...
  },
  {
    ...
    landmarks: [
      ...
      { name: "left_shoulder", x: 0.4, y: 0.24 },
      { name: "right_shoulder", x: 0.6, y: 0.24 },
      ...
      { name: "left_knee", x: 0.45, y: 0.7 },
      { name: "right_knee", x: 0.55, y: 0.7 },
      { name: "left_ankle", x: 0.45, y: 0.9 },
      { name: "right_ankle", x: 0.55, y: 0.9 },
    ],
  },
  {
    name: "Arms Extended",
    ...
    landmarks: [
      ...
      { name: "left_elbow", x: 0.18, y: 0.3 },
      { name: "right_elbow", x: 0.82, y: 0.3 },
    ...
    <div className="min-h-screen bg-gray-900 p-4">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold text-white mb-4">
          🎯 Test Skeleton Detection (Interactive)
        </h1>
        ...
        <div className="mt-4 bg-blue-900 text-white p-4 rounded">
          ...
          <ol className="list-decimal list-inside space-y-2 text-sm">
            ...
            <li>
              <strong className="text-yellow-300">Pilih Pose Preset</strong>{" "}
              yang paling sesuai dengan pose di foto
            </li>
            <li>
              <strong className="text-green-300">
                Drag & drop titik-titik
              </strong>{" "}
              untuk adjust posisi skeleton
            </li>
            <li>
              Klik <strong>Download Hasil</strong> untuk save
            </li>
          </ol>
          ...
          <div className="mt-4 pt-4 border-t border-blue-700">
            ...
            <ul className="text-sm space-y-1">
              <li>
                ✅ <strong>4 Pose Presets</strong> - Standing Normal, Arms Up,
                Arms Extended, Casual
              </li>
              <li>
                ✅ <strong>Drag & Drop</strong> - Klik dan drag titik untuk
                adjust
              </li>
              <li>
                ✅ <strong>Interactive Canvas</strong> - Real-time adjustment
              </li>
